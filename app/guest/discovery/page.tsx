...
const ITEMS = [
  { id: 1,  name: 'Alpenrosen Weg',         type: 'Nature'   as Cat, distance: '1.2 km', time: '45 min',    difficulty: 'Easy',     desc: 'A gentle path through alpine rose meadows above Obergurgl. Peak bloom June–August. Granite outcrops and panoramic Oetztal valley views at every turn.',               mood: 'Still & vast',      season: 'Summer',   color: '#2D4A3E', bg: 'linear-gradient(160deg, #1a3028 0%, #2d4a3e 50%, #4a7a58 100%)',    tags: ['Walking', 'Views', 'Alpine flora'],        direction: 'NE', bearing: 48,  isPartner: false, img: IMG('photo-1464822759023-fed622ff2c3b') },
  { id: 2,  name: 'Sennalm Längenfeld',    type: 'Food'     as Cat, distance: '3.4 km', time: '2 h',       difficulty: 'Moderate', desc: 'Traditional alpine dairy producing Graukase and mountain butter since 1847. Watch the morning process and taste directly from the wheel.',                              mood: 'Warm & rooted',     season: 'All year', color: '#7a5830', bg: 'linear-gradient(160deg, #3a2810 0%, #7a5830 50%, #b88840 100%)',    tags: ['Local', 'Food', 'Heritage'],               direction: 'E',  bearing: 92,  isPartner: true, partnerDiscount: { label: '15% guest discount', saving: '€4 off tasting' }, img: IMG('photo-1452195100486-9cc7a768be89') },
  { id: 3,  name: 'Pestkapelle Sölden',     type: 'Culture'  as Cat, distance: '0.8 km', time: '20 min',    difficulty: 'Easy',     desc: 'A 14th-century plague chapel perched on a rocky outcrop above Sölden. Frescoes, silence, and a view unchanged since the medieval period.',                            mood: 'Quiet & ancient',   season: 'All year', color: '#5a4830', bg: 'linear-gradient(160deg, #2a2018 0%, #5a4830 50%, #8a7050 100%)',    tags: ['History', 'Architecture', 'Silence'],      direction: 'W',  bearing: 270, isPartner: false, img: IMG('photo-1548502499-ef49dcf78038') },
  { id: 4,  name: 'Wildwasser Kneipp',       type: 'Wellness' as Cat, distance: '0.4 km', time: '30 min',    difficulty: 'Easy',     desc: 'A natural cold-water Kneipp path fed by glacial melt from the Oetztal glaciers. Water temperature: 7°C. Three circuits, full reset.',                                mood: 'Sharp & alive',     season: 'May–Oct', color: '#1e3a58', bg: 'linear-gradient(160deg, #0e2038 0%, #1e3a58 50%, #3a6080 100%)',    tags: ['Cold water', 'Wellness', 'Reset'],         direction: 'N',  bearing: 12,  isPartner: false, img: IMG('photo-1520962880247-cfaf541d8354') },
  { id: 5,  name: 'Gasthof Schiefer Giebel', type: 'Food'     as Cat, distance: '5.1 km', time: '3 h hike',  difficulty: 'Moderate', desc: 'A mountain Gasthof at 2,100 m with Kasspatzln, smoked Oetztal trout, and Zirbenschnaps. 18 seats. Reserve via the hotel concierge.',                               mood: 'Convivial & slow',  season: 'Jun–Sep', color: '#4A6741', bg: 'linear-gradient(160deg, #1e3018 0%, #4a6741 50%, #7a9a60 100%)',    tags: ['Dining', 'Regional', 'Hike-to'],           direction: 'SE', bearing: 135, isPartner: true, partnerDiscount: { label: 'Complimentary Zirbenschnaps', saving: 'welcome drink' }, img: IMG('photo-1414235077428-338989a2e8c0') },
  { id: 6,  name: 'E-Bike Ötztal Circuit',  type: 'Mobility' as Cat, distance: '38 km',  time: '2.5 h',     difficulty: 'Easy',     desc: 'Solar-charged e-bike loop through the valley floor, past two glacial lakes and the villages of Längenfeld, Umhausen, and Haiming.',                                    mood: 'Free & flowing',    season: 'Apr–Oct', color: '#284850', bg: 'linear-gradient(160deg, #0e2830 0%, #284850 50%, #4a7888 100%)',    tags: ['E-Bike', 'Zero emission', 'Lakes'],        direction: 'S',  bearing: 185, isPartner: false, img: IMG('photo-1471623432079-b009d30b6729') },
  { id: 7,  name: 'Aqua Dome Längenfeld',   type: 'Partners' as Cat, distance: '4.2 km', time: 'Half day',  difficulty: 'Easy',     desc: 'The iconic thermal spa of the Ötztal. Three outdoor thermal pools at different temperatures, sauna world, and panoramic mountain views. AlpineFlow guests pay the local resident rate.', mood: 'Warm & vast',  season: 'All year', color: '#1e3a58', bg: 'linear-gradient(160deg, #0e2038 0%, #1e3a58 50%, #4a6888 100%)',    tags: ['Thermal', 'Premium', 'Spa'],               direction: 'S',  bearing: 195, isPartner: true, partnerDiscount: { label: '€18 off entry', saving: 'Standard: €38 → €20' }, img: IMG('photo-1519817650390-64a9db95544b') },
  { id: 8,  name: 'Timmelsjoch Sunrise',     type: 'Nature'   as Cat, distance: '2.2 km', time: '1.5 h',     difficulty: 'Moderate', desc: 'A glacial lake at 1,840 m on the path toward the Timmelsjoch pass. Depart at 5:30 am. The first light lasts 12 minutes. Nothing else like it.',                      mood: 'Awe & solitude',    season: 'May–Oct', color: '#1a2a48', bg: 'linear-gradient(160deg, #0e1828 0%, #1a2a48 50%, #3a5888 100%)',    tags: ['Sunrise', 'Glacial lake', 'Photography'], direction: 'NE', bearing: 65,  isPartner: false, img: IMG('photo-1501854140801-50d01698950b') },
]
...
export default function DiscoveryPage() {
  ...
  const hero = expanded !== null ? ITEMS.find(d => d.id === expanded) ?? null : null

  const getVoucher = (item: Item) => {
  ...
  const heroImgX = 50 + (heroMouse.x - 50) * 0.12
  const heroImgY = 50 + (heroMouse.y - 50) * 0.12
  ...
  return (
    <main style={{ minHeight: '100vh', background: hero ? hero.bg : 'linear-gradient(160deg, #F7F4EF 0%, #EDE7DC 100%)', transition: 'background 1.5s cubic-bezier(0.16,1,0.3,1)' }}>
      ...
      {/* Expanded hero with mouse parallax */}
      {hero && (
        <div style={{ padding: '3rem 2rem 2rem', maxWidth: 960, margin: '0 auto' }}>
          <button onClick={() => { setExpanded(null); setHeroMouse({ x: 50, y: 50 }) }} style={{ background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.18)', color: 'rgba(237,231,220,0.75)', borderRadius: 100, padding: '6px 16px', fontFamily: 'var(--font-sans)', fontWeight: 300, fontSize: '0.75rem', cursor: 'pointer', marginBottom: '2rem', backdropFilter: 'blur(12px)' }}>← Back</button>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '3rem', alignItems: 'start' }}>
            <div>
              ...
              <div
                ...
                style={{ position: 'relative', height: 280, borderRadius: 18, overflow: 'hidden', marginBottom: '1.5rem', cursor: 'crosshair' }}
              >
                <img
                  src={hero.img}
                  alt={hero.name}
                  style={{
                    ...
                    objectFit: 'cover',
                    objectPosition: `${heroImgX}% ${heroImgY}%`,
                    top: '-4%', left: '-4%',
                    transition: 'object-position 0.35s cubic-bezier(0.16,1,0.3,1)',
                  }}
                />
                <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, transparent 50%, rgba(0,0,0,0.28) 100%)', pointerEvents: 'none' }} />
                <div style={{ position: 'absolute', bottom: '0.875rem', right: '1rem', fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 300, fontSize: '0.7rem', color: 'rgba(237,231,220,0.5)', pointerEvents: 'none' }}>move to explore</div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '0.6rem' }}>
                ...
                {hero.isPartner && hero.partnerDiscount && (
                  <button onClick={() => getVoucher(hero)} style={{ background: vouchers[hero.id] ? 'rgba(201,169,110,0.25)' : 'rgba(201,169,110,0.15)', border: '1px solid rgba(201,169,110,0.4)', color: 'rgba(237,231,220,0.9)', borderRadius: 100, padding: '9px 20px', fontFamily: 'var(--font-sans)', fontWeight: 300, fontSize: '0.8rem', cursor: 'pointer', backdropFilter: 'blur(12px)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px,1fr))', gap: '1rem' }}>
            {visible.map((d, idx) => (
              <div
                ...
                style={{ borderRadius: 18, overflow: 'hidden', cursor: 'pointer', background: 'rgba(250,248,244,0.82)', border: '1px solid rgba(200,184,154,0.2)', transition: 'all 0.4s cubic-bezier(0.16,1,0.3,1)', opacity: loaded ? 1 : 0, transform: loaded ? 'none' : `translateY(${10 + idx * 4}px)`, transitionDelay: loaded ? '0ms' : `${idx * 40}ms` }}

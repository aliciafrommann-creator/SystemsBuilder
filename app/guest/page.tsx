...
const MODES = [
  { id: 'eco',         name: 'Eco Stay',       subtitle: 'Light touch on the earth',      color: '#1A2E28', light: '#2a4a38', accent: '#4a8a6a', text: 'rgba(210,235,220,0.9)', bg: '#111e1a', icon: '◇', desc: 'Solar-heated rooms, foraged breakfast, zero single-use plastics. Your stay leaves the forest exactly as you found it.' },
  { id: 'quiet',       name: 'Quiet Stay',      subtitle: 'Deep rest, undisturbed',         color: '#1E2638', light: '#283850', accent: '#5a82b8', text: 'rgba(205,218,238,0.9)', bg: '#131825', icon: '◎', desc: 'No calls, no notifications. Blackout rooms, curated library, and silent meditation paths through the pines.' },
  { id: 'wellness',    name: 'Wellness Stay',   subtitle: 'Renew body and mind',            color: '#2C1E18', light: '#4a3228', accent: '#c9a96e', text: 'rgba(240,225,205,0.9)', bg: '#1a1210', icon: '◠', desc: 'Alpine spa, thermal pools, plant-based nourishment and sunrise movement sessions with mountain guides.' },
  { id: 'explorer',    name: 'Explorer Stay',   subtitle: 'Discover the region',            color: '#1E2C18', light: '#2e4228', accent: '#a4b768', text: 'rgba(222,235,210,0.9)', bg: '#131c10', icon: '◈', desc: 'Local guides, e-bikes, hand-drawn maps to hidden trails and artisan villages. Off the beaten path, always.' },
  { id: 'deep-rest',   name: 'Deep Rest',       subtitle: 'Nothing is required of you',     color: '#221830', light: '#362850', accent: '#9b78c8', text: 'rgba(228,218,245,0.9)', bg: '#160f20', icon: '◡', desc: 'Floating breakfast, heated blankets, curated reading nooks. The only decision you make: when to sleep.' },
  { id: 'alpine-reset',name: 'Alpine Reset',    subtitle: 'The full mountain experience',   color: '#18222E', light: '#243448', accent: '#7ba3a8', text: 'rgba(212,228,235,0.9)', bg: '#101820', icon: '◯', desc: 'Cold-plunge mornings, pine sauna evenings, fireside dinners, and star-gazing above the treeline.' },
]
              ...
              >
                ...
                {isActive && (
                  <div style={{ marginTop: '1.15rem', paddingTop: '1.15rem', borderTop: `1px solid ${mode.accent}28` }}>
                    ...
                    <Link href="/guest/wellness"><button style={{ background: mode.accent, color: '#fff', border: 'none', borderRadius: 100, padding: '8px 22px', fontSize: '0.78rem', fontFamily: 'var(--font-sans)', fontWeight: 400, cursor: 'pointer', letterSpacing: '0.05em', boxShadow: `0 4px 18px ${mode.accent}50` }}>Explore wellness →</button></Link>
                  </div>
                )}
              </button>
            )
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '0.8rem' }}>
            {SERVICES.map(a => (
              <Link key={a.l} href={a.h}>
                <div style={{ borderRadius: '14px', padding: '1.15rem 1rem', cursor: 'pointer', background: selected ? 'rgba(255,255,255,0.045)' : 'rgba(250,250,247,0.72)', border: selected ? '1px solid rgba(255,255,255,0.065)' : '1px solid rgba(200,184,154,0.18)', transition: 'all 0.38s cubic-bezier(0.16,1,0.3,1)' }}
